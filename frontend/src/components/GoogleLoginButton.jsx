  ...
  return (
    <div className="w-full">
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-blue-600/0 via-blue-500/0 to-red-500/0 opacity-0 group-hover:opacity-10 transition-opacity duration-300" />
        ...
        <div className="relative flex items-center justify-center gap-3">
          {loading ? (
            ...
            <>
              ...
              {/* Arrow icon */}
              <svg
                className="ml-auto h-4 w-4 text-slate-500 group-hover:text-slate-300 group-hover:translate-x-0.5 transition-all duration-200"
