...
const Navbar = () => {
  ...
  const linkClasses =
    "text-xs sm:text-sm text-slate-300 hover:text-white transition-colors";
  ...
  return (
    <nav className={`sticky top-0 z-30 border-b transition-all duration-300 ${
      isScrolled 
          ...
          {loading ? (
            ...
            <>
              {user.role === 'teacher' && (
                <Link
                  to="/create-session"
                  className="hidden sm:inline-flex text-xs px-3 py-1.5 rounded-full bg-slate-900 text-slate-100 border border-slate-700 hover:border-emerald-400 hover:text-white hover:-translate-y-0.5 hover:shadow-lg hover:shadow-emerald-500/20 transition-all duration-200"
                >
                  + Upload Course
                </Link>
              )}
            ...
            <>
              ...
              <Link
                to="/register"
                className="text-xs px-3 py-1.5 rounded-full border border-slate-600 text-slate-100 hover:border-emerald-400 hover:text-white hover:-translate-y-0.5 hover:shadow-lg hover:shadow-emerald-500/20 transition-all duration-200 hidden sm:inline-flex"
              >
                Join free
              </Link>
            </>
