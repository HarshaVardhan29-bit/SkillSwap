  ...
  return (
    <div className="bg-black text-white overflow-x-hidden scroll-smooth">
      ...
      <footer className="py-8 bg-black/90 border-t border-white/10 text-center text-slate-400 text-xs">
        SkillSwap © 2025 — Designed & Developed by{" "}
        <a href="https://harshavardhan29-bit.github.io/portfolio/" target="_blank" rel="noopener noreferrer" className="text-emerald-300 hover:text-emerald-200 transition-colors">
