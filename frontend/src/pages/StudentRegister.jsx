  ...
  return (
    <div className="min-h-[calc(100vh-64px)] bg-slate-950 flex items-center justify-center px-4">
      <div className="max-w-lg w-full relative">
        ...
        <div className="absolute -bottom-10 -right-10 h-32 w-32 bg-indigo-500/20 blur-3xl rounded-full" />
        ...
        <div className="relative bg-slate-900/80 border border-slate-700/70 rounded-2xl shadow-xl p-6 sm:p-8 backdrop-blur">
          <div className="mb-5 text-center space-y-2">
            <p className="text-xs text-blue-300/90 font-medium uppercase tracking-[0.2em]">
              Student Portal
            </p>
            ...
            <p className="text-xs text-slate-400 max-w-md mx-auto">
              Join as a student to learn new skills from experienced teachers.
            </p>
          </div>
          ...
          <form className="space-y-3" onSubmit={handleSubmit}>
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full bg-slate-900 border border-slate-700 rounded-lg px-3 py-2 text-sm text-white placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/70"
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-slate-900 border border-slate-700 rounded-lg px-3 py-2 pr-10 text-sm text-white placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/70"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              className="w-full bg-blue-500 hover:bg-blue-400 text-white text-sm font-medium py-2.5 rounded-lg mt-2 transition shadow-lg shadow-blue-500/30"
            >
              Create Student Account
            </button>
          </form>
          ...
          {/* Google Signup */}
          <GoogleLoginButton role="student" label="Sign up with Google" />
